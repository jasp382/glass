...
def get_cellsize(rst, xy=False, bnd=None, gisApi='gdal'):
    ...
    * pygrass
    ...
    if gisApi == 'gdal':
        from osgeo           import gdal
        from glass.geo.gm.prop.img import get_cell_size
...
def count_cells(raster, countNodata=None):
    ...
    from glass.geo.gt.fmrst import rst_to_array
    from glass.pyt.num  import count_where
...
def adjust_ext_to_snap(outExt, snapRst):
    ...
    from glass.geo.gt.prop.ff  import check_isShp, check_isRaster
    from glass.geo.gt.prop.rst import rst_ext, get_cellsize
    from glass.geo.gm.to       import new_pnt, create_polygon
    ...
    if isRst:
        ...
        if isShp:
            from glass.geo.gt.prop.feat import get_ext
...
def raster_report(rst, rel, _units=None, ascmd=None):
    ...
    ** p: percent cover
    ...
    if not ascmd:
        ...
        from glass.pyt import obj_to_lst, execmd
