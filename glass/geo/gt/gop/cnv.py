...
def polyline_to_points(inShp, outShp, attr=None, epsg=None):
    ...
    from glass.geo.gm.lyr.fld import copy_flds
    ...
    if not epsg:
        ...
        from glass.geo.gt.prop.prj import get_sref_from_epsg
...
def polylines_from_points(points, polylines, POLYLINE_COLUMN,
    ...
    from glass.geo.gt.prop.fld import ogr_list_fields_defn
    from glass.geo.gm.lyr.fld   import fields_to_lyr
...
def feat_to_pnt(inShp, outPnt, epsg=None):
    ...
    from glass.geo.gt.prop.ff   import drv_name
    from glass.geo.gm.lyr.fld   import copy_flds
    from glass.geo.gt.prop.feat import lst_fld
...
def lnh_to_polygons(inShp, outShp, api='saga', db=None):
    ...
    * psql;
    ...
    if api == 'saga':
        ...
        from glass.geo.gt.toshp.cgeo import line_to_polyline
        from glass.geo.gt.toshp.cgeo import geomtype_to_geomtype
        from glass.geo.gt.toshp.cgeo import boundary_to_areas
