...
def grs_rst_roads(osmdb, lineTbl, polyTbl, dataFolder, LULC_CLS):
    ...
    from glass.sql.i        import row_num
    ...
    if NB:
        ...
        from glass.geo.gt.nop.rcls import set_null, null_to_value
...
def grs_vec_roads(osmdb, lineTbl, polyTbl):
    ...
    from glass.sql.i            import row_num
    from glass.geo.gt.toshp.db  import dbtbl_to_shp
    from glass.geo.gt.prox.bf   import _buffer
    ...
    if NB:
        ...
        from glass.geo.gt.tbl.grs import update_table
...
def roads_sqdb(osmdb, lnhTbl, plTbl, apidb='SQLITE', asRst=None):
    ...
    import datetime
    from glass.sql.i        import row_num as cnt_rows
...
def num_roads(osmdata, nom, lineTbl, polyTbl, folder, cellsize, srs, rstTemplate):
    ...
    from glass.geo.gql.prox import splite_buffer
    from glass.geo.gt.torst import shp_to_rst, obj_to_rst
    from glass.sql.i    import row_num
