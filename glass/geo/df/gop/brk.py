...
def vedit_break(inShp, pntBreakShp,
    ...
    if os.path.isfile(pntBreakShp):
        from glass.dct.geo.fmshp import points_to_list
...
def break_lines_on_points(lineShp, pntShp, outShp, lnhidonpnt,
    ...
    if api == 'shply':
        ...
        from glass.dct.gql          import shp_to_psql
        from glass.dct.geo.toshp.db import dbtbl_to_shp
        from glass.geo.gql.brk      import split_lines_on_pnt
