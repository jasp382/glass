...
def grs_to_rst(grsRst:str, rst:str, as_cmd:None|bool=None,
               allBands:None|bool=None, dtype:None|str=None, nodata:None|float|int=None) -> str:
    """
    ...
    typeref = {
        'Byte'    : int, 'UInt16' : int, 'Int16' : int,
        'CInt16'  : int,
        'UInt32'  : int, 'Int32' : int, 'CInt32' : int,
        'Float32' : float, 'CFloat32' : float,
        'Float64' : float, 'CFloat64' : float,
    ...
    sandtype = {
        ...
        'CInt16'  : 'CInt16',
        'UInt32'  : 'UInt32', 'Int32' : 'Int32', 'CInt32' : 'CInt32',
        'Float32' : 'Float32', 'CFloat32' : 'CFloat32',
        'Float64' : 'Float64', 'CFloat64' : 'CFloat64',
        'uint16' : 'UInt16', 'int16' : 'Int16',
        'uint8': 'Byte', 'int8' : 'Int16'
    }

    dtype = sandtype[dtype] if dtype else None

    rtype = typeref[dtype] if dtype else None
