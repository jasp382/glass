...
def pgtables_to_layer_withStyle_by_col(
    ...
    from glass.wg.gsrv.sty    import create_style
    from glass.wg.gsrv.sty    import lst_styles
    from glass.wg.gsrv.sty    import del_style
    from glass.wg.gsrv.sty    import assign_style_to_layer
    from glass.wg.sld         import write_sld
...
def pgtables_groups_to_layers(groups_of_tables, db, workName, storeName):
    ...
    import os; from glass.prop.sql  import lst_tbl
