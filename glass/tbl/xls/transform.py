...
def year_to_col_by_attr(data_file, data_spreadsheet,
    ...
    from glass.tbl.xls.fld  import get_columns_position
    from glass.tbl.xls.fld  import get_columns_position_outside_options
    from glass.tbl.xls.summ import list_unique_values_column
    from glass.tbl.xls.fm   import get_unit_attributes
...
def split_col_by_year(dataFile, sheetName, codeCol, yearCol, out_file):
    ...
    import codecs
    from glass.tbl.xls.fld  import get_columns_position, get_columns_position_outside_options
    from glass.tbl.xls.summ import list_unique_values_column
