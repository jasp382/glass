...
from gportal.views import map_view
from gportal.views import get_extent
from gportal.views import get_wfs
from gportal.views import get_featinfo
from gportal.views import get_wms
from gportal.views import get_legend_ml
