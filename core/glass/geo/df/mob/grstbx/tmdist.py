...
def distance_between_catpoints(srcShp, facilitiesShp, networkShp, speedLimitCol,
    ...
    from glass.geo.df.mob.grstbx.vnet import network_from_arcs
    from glass.geo.df.mob.grstbx.vnet import add_pnts_to_network
    from glass.geo.df.mob.grstbx.vnet import netpath
