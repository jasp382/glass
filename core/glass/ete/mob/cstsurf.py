...
def cost_surface(dem, lulc, lulc_col, prod_lulc, roads, kph, barr, output):
    ...
    from glass.g.prop.rst import get_cellsize, rst_distinct
    ...
    from glass.g.rst.rcls  import interval_rules
    from glass.g.rst.rcls  import category_rules
    ...
    from glass.g.prop.rst  import raster_report
    from glass.g.rst.mos   import rsts_to_mosaic
    from glass.g.dp.torst  import shp_to_rst
    from glass.g.rst.rcls  import rcls_rst, set_null
...
def acumulated_cost(cst_surface, dest_pnt, cst_dist):
    ...
    from glass.g.rst.alg import rstcalc
    from glass.g.rst.dst import rcost
    from glass.g.it.rst  import rst_to_grs, grs_to_rst
