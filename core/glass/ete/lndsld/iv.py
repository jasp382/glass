...
def infovalue(landslides, variables, iv_rst):
    ...
    from glass.g.prop.rst  import count_cells
...
def grs_infovalue(movs, _var, refrst, out):
    ...
    import os
    import math as m
    from glass.g.gp.ext   import rstext_to_rst
    from glass.g.prop     import check_isRaster
    from glass.g.prop.rst import rst_shape, frequencies
