...
def raster_based(osmdata, nomenclature, refRaster, lulcRst,
    ...
    if roadsAPI == 'POSTGIS':
        ...
        from glass.dct.gql           import osm_to_psql 
        from glass.ete.osm2lulc.mod2 import roads_sqdb
        from glass.dct.sql.fm        import dump_db
        from glass.sql.db            import drop_db
    else:
        from glass.dct.geo.toshp.osm  import osm_to_sqdb
    ...
    from glass.geo.df.nop.mos import rsts_to_mosaic
...
def vector_based(osmdata, nomenclature, refRaster, lulcShp,
    ...
    * POSTGIS
    ...
    from glass.dct.geo.toshp.mtos    import same_attr_to_shp
    ...
    # IMPORT SOME glass MODULES FOR GRASS GIS #
    # ************************************************************************ #
    from glass.geo.df.gop.ovl import erase
    from glass.geo.wenv.grs     import rst_to_region
    from glass.geo.df.gop.genze import dissolve
    from glass.geo.df.tbl.grs   import add_and_update, reset_table, update_table
    from glass.geo.df.tbl.fld   import add_fields
    from glass.dct.geo.toshp.cff import shp_to_grs, grs_to_shp
    from glass.dct.geo.torst     import rst_to_grs
    # ************************************************************************ #
    # SET GRASS GIS LOCATION EXTENT #
    # ************************************************************************ #
    extRst = rst_to_grs(refRaster, 'extent_raster')
