...
def groups_to_lines(xls_data, xls_sheet,
    ...
    from glass.ng.xls.fld import get_columns_position
...
def year_to_col_by_attr(data_file, data_spreadsheet,
    ...
    from glass.ng.xls.fld  import get_columns_position
    from glass.ng.xls.fld  import get_columns_position_outside_options
    from glass.ng.xls.summ import list_unique_values_column
    from glass.ng.xls.fm   import get_unit_attributes
...
def split_col_by_year(dataFile, sheetName, codeCol, yearCol, out_file):
    ...
    import codecs
    from glass.ng.xls.fld  import get_columns_position, get_columns_position_outside_options
    from glass.ng.xls.summ import list_unique_values_column
