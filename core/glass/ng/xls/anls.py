...
def frequencies_by_place(xls, entities_sheet, entities_id, entities_place,
    ...
    from glass.ng.xls.summ import count_values_column
    from glass.ng.xls.summ import count_values_column_if_entity_exists
    from glass.ng.xls.summ import count_values_column_by_entity_property
