...
export class api {
     ...
     */
    public static firelocTokenUrl: string = api.url + 'floc/fireloc/';
    /**
     * Event URL to perform actions on FireLoc events (no authentication required)
     */
    public static firelocUrl: string = api.url + 'floc/fireloc-uu/';
     ...
     */
    public static clusterLayersUrl: string = api.url + 'geovis/cluster-layers/';
    ...
    public static wmsUrl: string = api.url + 'geosrv/wms/';
