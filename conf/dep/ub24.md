...
=======
cd ~/ && wget https://github.com/OSGeo/grass/archive/refs/tags/8.4.0.tar.gz && tar -xzvf 8.4.0.tar.gz
>>>>>>> 74a3f6c (Dev operations 2025)
...
<<<<<<< HEAD
sudo apt install postgresql-client-18 postgis postgresql-common postgresql-18 postgresql-18-postgis-3 postgresql-18-ogr-fdw=1.1.8-2.pgdg24.04+1 postgresql-18-postgis-3-scripts postgresql-plpython3-18 postgresql-18-pgrouting postgresql-server-dev-18 postgresql-18-cron -y

sudo apt-mark hold postgresql-18-ogr-fdw
=======
sudo apt install postgresql-client-17 postgis postgresql-common postgresql-17 postgresql-17-postgis-3 postgresql-17-ogr-fdw postgresql-17-postgis-3-scripts postgresql-plpython3-17 postgresql-17-pgrouting postgresql-server-dev-17 postgresql-17-cron -y
>>>>>>> 74a3f6c (Dev operations 2025)
```
...
sudo apt install libwxgtk3.2-dev libgdal-dev libproj-dev libpq-dev libopencv-dev libhpdf-dev unixodbc-dev -y
sudo apt-get install g++ cmake cmake-qt-gui make libtool git -y
