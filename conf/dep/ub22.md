...
sudo apt install -y --no-install-recommends libgl-dev libgl1 libxcb1 '^libxcb.*' libx11-xcb1 libglu1-mesa libxrender1 libxi6 libxkbcommon0 libxkbcommon-x11-0 libxinerama1

sudo chmod +x OTB-8.1.2-Linux64.run
./OTB-8.1.2-Linux64.run

echo "source ~/OTB-8.1.2-Linux64/otbenv.profile" | sudo tee --append ~/.bashrc
