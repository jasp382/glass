Install Application dependencies in Ubuntu 16.04:
====================
...
cd Python-3.6.9
./configure --enable-optimizations --prefix=/opt/python-3.6.9
make -j 8
sudo make install

echo "export PATH=/opt/python/bin:$PATH" | sudo tee --append ~/.bashrc
