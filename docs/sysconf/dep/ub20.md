...
### 10 - Install GeoServer:

**10.1 - Install Apache2:**
...
**7.3 - Install GeoServer:**

```
sudo apt install unzip

mkdir ~/geoserver_inst && sudo wget http://sourceforge.net/projects/geoserver/files/GeoServer/2.22.2/geoserver-2.22.2-war.zip -P ~/geoserver_inst/

sudo unzip ~/geoserver_inst/geoserver-2.22.2-war.zip -d ~/geoserver_inst/
